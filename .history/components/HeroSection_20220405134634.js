...
function HeroSection() {
  return (
    <div className="flex min-h-screen flex-row bg-white ">
      ...
      <div className="box-border flex max-h-screen w-1/2 justify-center border-2 bg-slate-500 text-center">
        ...
        <div className="h-1/2 w-1/2 bg-green-300 align-baseline"></div>
      </div>
    </div>
  )
}
