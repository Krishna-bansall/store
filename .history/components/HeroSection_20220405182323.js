  ...
  return (
    <div className="flex min-h-screen flex-row bg-white ">
      ...
      <div className="flex w-full md:grid md:grid-cols-3">
        <div className="z-10 flex w-screen flex-col items-center justify-center px-10 text-center md:col-span-2 md:items-start md:px-20 md:text-left">
        ...
        <div className="absolute z-40 flex min-h-screen min-w-full items-center justify-center md:hidden">
          <div className="absolute flex h-1/4 w-full -translate-y-40 justify-center bg-black">
            <Image className="h-1/4 w-1/4" src={rocket} alt="Rocket" />
          </div>
          <div className="absolute h-1/4 w-full translate-y-20 bg-black"></div>
        </div>
