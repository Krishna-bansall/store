  ...
  return (
    <div className="flex min-h-screen flex-row bg-white ">
      ...
      <div className="flex w-full md:grid md:grid-cols-3">
        <div className="z-10 flex w-screen flex-col items-center justify-center px-10 text-center md:relative md:col-span-2 md:items-start md:px-20 md:text-left">
        ...
        <div className="absolute z-40 grid min-h-screen min-w-full grid-cols-3 grid-rows-3  md:hidden">
          <div className="col-start-2 col-end-2 h-full justify-center">
            <Image className="h-10 w-10 bg-black" src={rocket} alt="Rocket" />
          </div>
        </div>
