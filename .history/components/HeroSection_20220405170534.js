      ...
      <div className="flex w-full md:grid md:grid-cols-3">
        <div className="z-10 flex w-screen flex-col items-center justify-center border-2 px-10 text-center md:col-span-2 md:items-start md:px-20 md:text-left">
          <div className="-translate-y-1/3">
            <div className="mb-1 max-w-xl text-lg font-semibold tracking-wide md:text-3xl xl:text-5xl">
              The NextJs eCommerce
            </div>
            <div
              className="xl:text-10xl mb-3 max-w-xl bg-gradient-to-r from-orange-400 via-purple-400 to-pink-600
            bg-clip-text text-4xl font-black text-transparent drop-shadow-lg md:text-7xl md:tracking-wide"
            >
              Fast & Modern
            </div>
