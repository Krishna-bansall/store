                  ...
                  {cart.length > 0 && (
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                      ...
                      <div className="mt-6">
                        <a
                          href="#"
                          className="hover:bg-gray-800700 flex items-center justify-center rounded-md border border-transparent bg-black px-6 py-3 text-base font-medium text-white shadow-sm"
                        >
                          Checkout
                        </a>
                      </div>
