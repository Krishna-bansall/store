  ...
  return (
    <div className="flex min-h-screen flex-row bg-white ">
      ...
      <div className="flex">
        ...
        <div className="absolute max-h-screen border-2">
          <Image className="relative  " src={rocket} alt="Rocket" />
          <Image className="absolute  " src={machine} alt="machine" />
          <Image className="absolute  " src={cursor} alt="cursor" />
        </div>
      </div>
    </div>
  )
