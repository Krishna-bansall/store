...
function HeroSection() {
  return (
    <div className="flex min-h-screen flex-row bg-white ">
      ...
      <div className="flex max-h-screen border-2">
        <div className="relative box-border flex max-h-screen bg-slate-500 text-center">
          <Image
            className="relative left-0 right-0 top-0 max-w-full"
            src={rocket}
            alt="Rocket"
          />
          <Image
            className="relative left-0 right-0 -top-80  max-w-full"
            src={machine}
            alt="machine"
          />
          <Image
            className="relative left-0 right-0 z-30 max-w-full -translate-y-20 "
            src={cursor}
            alt="cursor"
          />
        </div>
