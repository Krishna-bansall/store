...
function HeroSection() {
  return (
    <div className="relative grid h-screen grid-cols-2 bg-white">
      <div
        className=":py-20 z-10 col-span-2 grid max-h-screen grid-cols-[1fr_3fr_1fr] 
      grid-rows-[3fr_2fr_3fr] px-4 md:grid-cols-[2fr_1fr] md:grid-rows-[1fr_2fr_2fr] md:px-20"
      >
        ...
        <div className="visible  col-start-2 row-start-1 flex items-end justify-center md:hidden">
          <div className="absolute flex w-1/4  items-end">
            <Image className="absolute -rotate-90 " src={rocket} alt="Rocket" />
          </div>
        </div>
