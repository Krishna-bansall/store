  ...
  return (
    <div className="relative grid h-screen grid-cols-2 bg-white">
      ...
      >
        ...
        <div className="col-start-2 row-start-1 grid md:row-start-2 md:items-start ">
          <div className="flex items-end md:absolute md:grid md:self-center md:justify-self-end">
            <Image
