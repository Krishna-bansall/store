...
function HeroSection() {
  return (
    <div className="flex min-h-screen flex-row bg-white ">
      ...
      <div className="flex">
        <div className="z-10 flex flex-col justify-center border-2 px-10">
      ...
      <div className="flex-shrink-1/2 box-border flex max-h-screen items-center justify-center border-2 bg-slate-500 text-center">
